                        ...
                        <div class="row justify-content-center">
                            <div class="col-md-6 col-lg-3">
                                <div class="statistic__item">
                                    <h2 class="number"><?= Association::getAssociationCount(); ?></h2>
                                    <span class="desc">Institutionen insgesamt</span>
                                    <div class="icon">
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="statistic__item">
                                    ...
                                    <span class="desc">Nutzer online</span>
                                    <div class="icon">
                                        <i class="zmdi zmdi-account-o"></i>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="statistic__item">
                                    <h2 class="number">0</h2>
                                    <span class="desc">Nutzer offline</span>
                                    <div class="icon">
                                        <i class="zmdi zmdi-account-o"></i>
                                    </div>
                                </div>
